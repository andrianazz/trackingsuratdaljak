    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="fw-bold">Disposisi Surat Kabid</h3>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#disposisi{{$row->id}}">
                                    <i class="fa  fa-plus"></i>Disposisi
                                </button>
                                ...
                                <div class="modal fade text-left" id="disposisi{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="disposisi{{$row->id}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/disposisi-surat/{{$row->id}}" method="POST">
                                                @method('PUT')
                                                @csrf
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary ml-1">
                                                        ...
                                                        <span class="d-none d-sm-block">Disposisi</span>
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
