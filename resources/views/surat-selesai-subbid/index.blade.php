                                                ...
                                                <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row justify-content-center align-items-center mb-2">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input required name="nomor_surat" type="text" id="nomor_surat" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row justify-content-center mb-2">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input required type="text" name="nama_wp" value=""  id="nama_wp" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="row justify-content-center mb-2">
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input required name="npwpd" type="text" class="form-control" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row justify-content-center mb-2">
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input required type="date" name="tgl_selesai_surat" class="form-control" value="" >
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <div class="col-md-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea required name="hasil_surat" rows="5" cols="60%"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
