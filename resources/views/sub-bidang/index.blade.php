                            ...
                            <div class="col-md-9">
                                <div class="form-group has-icon-left">
                                    <div class="position-relative">
                                        <input required type="text" name="nama_sub_bidang" class="form-control" placeholder="Masukkan Sub Bidang.." id="first-name-icon">
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editSubBidang{{$row->id}}">
                                    <i class="fa  fa-edit"></i>Ubah
                                </button>
                                
                                <div class="modal fade text-left" id="editSubBidang{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="editModal{{$row->id}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/sub-bidang/{{$row->id}}" method="post">
                                            @method('put')
                                            @csrf
                                                <div class="modal-body text-center">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                            <input type="text" name="nama_sub_bidang" class="form-control" placeholder="Masukkan Sub Bidang..." value="{{$row->nama_sub_bidang}}" id="first-name-icon">
                                                            <div class="form-control-icon">
