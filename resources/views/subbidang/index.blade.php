                        ...
                        <div class="col-md-7">
                            <div class="form-group has-icon-left">
                                <div class="position-relative">
                                    <input type="text" class="form-control" placeholder="Masukkan Sub Bidang.." id="first-name-icon">
                        ...
                        <table class="table table-striped dataTable-table" id="table1">
                            <thead>
                                <tr>
                                    ...
                                    <th data-sortable="" style="width: 65%;"><a href="#" class="dataTable-sorter">Sub Bidang</a></th>
